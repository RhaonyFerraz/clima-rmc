...
(function () {
  ...
  function initHistoryCharts() {
    ...
    // Padrão global escuro e nítido para legibilidade máxima
    ...
    chartTemp = new Chart(ctxTemp, {
      ...
      options: {
        ...
        plugins: {
          legend: {
            display: true,
            labels: { color: '#0f172a', font: { family: 'Inter', size: 13, weight: '700' }, boxWidth: 16, padding: 14 }
          },
          tooltip: {
  ...
  async function loadHistoricalData(cityId, hours) {
    ...
    try {
      ...
      if (chartTemp) {
        chartTemp.options.plugins.legend.labels.color = '#0f172a';
        chartTemp.options.plugins.legend.labels.font = { family: 'Inter', size: 13, weight: '700' };
